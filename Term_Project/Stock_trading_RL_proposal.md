...
**1. Giới thiệu**
  ...
  Tại Việt Nam, một vài nghiên cứu về dự đoán giá chứng khoán trên sàn HOSE đã được thực hiện trong thời gian gần đây, chủ yếu sử dụng mô hình học sâu (LSTM) với đầu vào là dữ liệu về giá chứng khoán trong quá khứ [10]. Một vài nghiên cứu trong trường đại học UIT được thực hiện nhưng chưa được công bố [4-9]
  
  Mục tiêu của đề tài này là áp dụng phương pháp học tăng cường để xây dựng và đánh giá hệ thông giao dịch tự động ở thị trường chứng khoán Việt Nam với đầu vào là dữ liệu giá chứng khoán trong quá khứ và thông tin ngôn ngữ tự nhiên từ các báo điện tử và mạng xã hội.
