...
**1. Giới thiệu**
  ...
  Về mặt học thuật, các mô hình học sâu với đầu vào là giá chứng khoán quá khứ và thông tin ngôn ngữ tự nhiên từ báo chí và mạng xã hội đã đạt được các kết quả vượt trội so với các mô hình học máy cổ điển trong việc dự đoán giá cổ phiếu trong tương lai [2]. Ngoài ra, việc kết hợp mô hình học sâu với phương pháp học tăng cường còn giải quyết những vấn đề mà phương pháp học sâu thông thường chưa tính đến. Phương pháp học tăng cường đã chứng minh được hiệu quả trong việc ra quyết định trong thời gian ngắn để đạt được lợi ích tối đa trong dài hạn, có tính đến yếu tố chi phí giao dịch, danh mục tiền mặt và chứng khoán hiện có, ... rất phù hợp trong ứng dụng đầu tư chứng khoán tự động. Ramit Sawhney và Arnav Wadhwa đã ứng dụng phương pháp học tăng cường để thực nghiệm mua bán chứng khoán trên sàn NASDAQ Shanghai, Shenzhen, Hong Kong [3] với kết quả vượt trội so với các mô hình học sâu khác trong quá khứ. 
  
  Tại Việt Nam, một vài nghiên cứu về dự đoán giá chứng khoán trên sàn HOSE đã được thực hiện trong thời gian gần đây, chủ yếu sử dụng mô hình học sâu (LSTM) với đầu vào là dữ liệu về giá chứng khoán trong quá khứ [10]. Một vài nghiên cứu trong trường đại học UIT được thực hiện nhưng chưa được công bố [4-9]. Hầu hết các nghiên cứu này đều thiếu các yếu tố để có thể ra quyết định giao dịch chứng khoán tự động như: không có đánh giá hiệu quả lâu dài, không đề cập đến chi phí giao dịch, ...
  
  Mục tiêu của đề tài này là áp dụng phương pháp học tăng cường để xây dựng và đánh giá hệ thống mô phỏng giao dịch tự động ở thị trường chứng khoán Việt Nam với đầu vào là dữ liệu giá chứng khoán trong quá khứ và thông tin ngôn ngữ tự nhiên từ các báo điện tử và mạng xã hội có tính đến yếu tố chi phí giao dịch để tối đa hóa lợi nhuận lâu dài.
...
**6. Trích dẫn**
  ...
  [4] Dương Minh Đức, Hệ dự đoán chỉ số VN - INDEX dựa trên mô hình học sâu, Nguyễn Việt Phương (2021)
  
  [5] Dương Minh Đức, Ứng dụng SVM và chuỗi thời gian dự đoán xu hướng thị trường chứng khoán Việt Nam, Trần Quốc Bảo (2017)
  
  [6] Võ Đình Bảy, Áp dụng phương pháp lai giữa thuật toán tối ưu bầy đàn và hồi qui vécto hỗ trợ trong dự đoán giá chứng khoán A hybrid PSO-SVR approach for Vietnam stock price prediction on market, Lê Đỗ Minh Nga (2017)
  
  [7] Đỗ Phúc, Ứng dụng luật kết hợp để khám pháp mối quan hệ giữa các tỉ số tài chính và giá chứng khoán, Huỳnh Văn Trận (2016)
  
  [8] Dương Minh Đức, Dự báo xu hướng chứng khoán dựa vào tin tức tài chính tại sàn giao dịch TPHCM (HOSE), Huỳnh Đức Huy (2015)
  
  [9] Hoàng Văn Kiếm, Ứng dụng text mining dự báo thị trường chứng khoán Việt Nam, Phạm Xuân Dũng (2015)
  
  [10] Huyen Giang Thi Thu; Thuy Nguyen Thanh; Tai Le Quy, https://ieeexplore.ieee.org/abstract/document/9373168
